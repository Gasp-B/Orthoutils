...
export function AuthLayout({ hero, card }: AuthLayoutProps) {
  return (
    <div className="min-h-[82vh] bg-gradient-to-b from-sky-50/80 via-white to-slate-50/80 py-12">
      <div className="mx-auto grid max-w-5xl grid-cols-1 items-start gap-10 px-4 md:px-6 lg:grid-cols-[1.05fr_0.95fr]">
        <div className="space-y-6">
          <span className="inline-flex items-center gap-2 rounded-full bg-white/80 px-4 py-2 text-xs font-semibold uppercase tracking-[0.08em] text-sky-900 shadow-sm ring-1 ring-sky-100">
            <span className="h-2.5 w-2.5 rounded-full bg-gradient-to-r from-sky-500 to-cyan-400 shadow-[0_0_0_4px_rgba(14,165,233,0.18)]" aria-hidden />
            {hero.pill}
          </span>
