...
- The older `20250620120000_create_resource_types.sql` migration was superseded by `20250804120000_create_resource_types.sql` (with RLS). It has been removed to keep the timeline monotonic and prevent `--include-all` prompts.
